...
int main(){
    ...
    //bookPairs(p1);
    //bookPairs(p2);
    //myfile << p1.getName() << ": " << p1.showBooks() << endl;
    //myfile << p2.getName() << ": " << p2.showBooks() << endl;
    ...
    while(p1.getBookSize() + p2.getBookSize() < 52 && d.size()>0){
        ...
        {    
            ...
            else
            {
                ...
                myfile << p2.getName() <<" asks- Do you have a " << card_chosen.rankString(card_chosen.getRank()) << "?" << endl;
                ...
                if (p1.sameRankInHand(card_chosen)){
                    ...
                    myfile << p1.getName() <<" says- Yes. I have " << count << " " << " cards of rank " << card_chosen.rankString(card_chosen.getRank()) <<"." << endl;
                }
                ...
                else
                {
                    ...
                    myfile << p2.getName() << " has drawn a " << drawn2.toString() << endl; 
                    p2.addCard(drawn2);
                }
